...
<head>
    ...
    <!-- Title Page-->
    <title>Formulaire pour ajouter une information</title>
            ...
            <nav class="navbar-mobile">
                <div class="container-fluid">
                    <ul class="navbar-mobile__list list-unstyled">
                        <li>
                            <a href="#">
                                <i class="far fa-check-square"></i>Ajout info</a>
                        </li>
                        <li>
                            <a href="/add-new">
                                <i class="fas fa-chart-bar"></i>Ajouter une actualité</a>
                        </li>
                        <li>
                            <a href="/comments">
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Formulaire pour ajouter une information </strong>
                                    </div>
                                    <div class="card-body card-block">
                                        <form action="/upload-information" method="post" class="form-horizontal">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    ...
                                                    <small class="form-text text-muted">Le titre de l`information</small>
                                                </div>
                                            </div>
