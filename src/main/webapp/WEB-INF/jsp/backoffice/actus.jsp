        ...
        <div class="page-content--bgf7">
            ...
            <section class="p-t-20">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h3 class="title-5 m-b-35">Liste de toutes les actualités enregistrées</h3>
                            <div class="table-data__tool">
                                <div class="table-data__tool-left">
                                    <div class="rs-select2--light rs-select2--md">
                                        <select class="js-select2" onchange="location = this.value;">
                                            <option selected="selected">Actus</option>
                            ...
                            <div class="table-responsive table-responsive-data2">
                                <table class="table table-data2">
                                    ...
                                    <tbody>
                                    <c:forEach items="${listenews}" var="neww">
                                        <tr class="tr-shadow">

                                            <td>
                                                <span class="block-email">${neww.title}</span>
                                            </td>
                                            <td>${neww.rewriting}</td>
                                            <td class="desc">${neww.url}</td>
                                            <td>${neww.postedOn}</td>

                                            <td>
                                                <div class="table-data-feature">

                                                    <a href="/add-new?id=${neww.id}"><button class="item" data-toggle="tooltip" data-placement="top" title="Edit">
                                                        <i class="zmdi zmdi-edit"></i>
                                                    </button><a>
                                                    <a href="/delete-new?id=${neww.id}"><button class="item" data-toggle="tooltip" data-placement="top" title="Delete">
